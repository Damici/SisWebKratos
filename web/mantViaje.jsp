...
<html>
    <head>
        ...
        <script src="js/inicializar.js" type="text/javascript" ></script>
    ...
    <body background="images/fondo.jpg">
        <div id="m_main">
            ...
            <div id="m_body">
                ...
                <div id="filtro">
                    <fieldset>
                        <legend><span>Par&aacute;metros</span></legend>
                        <table>
                            <tr>
                                <td>Periodo:</td>
                                <td><input type="number" min="2015" name="anio"></td>
                                <td><select id="mes" onchange="cargarMes();">
                                        <option></option>
                                    </select></td>
                            </tr>
                        </table>
